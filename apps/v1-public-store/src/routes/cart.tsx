...
function CartPage() {
  ...
  const { items, subtotal, totalItems, updateItemQuantity, removeFromCart, clearCart } = useCart()
                    ...
                    <div className="flex items-center justify-between mt-4">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          className="h-8 w-8"
                          onClick={() =>
                            updateItemQuantity(item.product.id, item.quantity - 1, item.variant?.id)
                          }
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            if (!isNaN(val) && val > 0) {
                              updateItemQuantity(item.product.id, val, item.variant?.id)
                            }
                          }}
