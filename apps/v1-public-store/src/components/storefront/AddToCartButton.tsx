    ...
    <div className={`flex items-center gap-2 ${className || ''}`}>
      {showQuantity && (
        <div className="flex items-center border rounded-md">
          ...
          <span className="w-10 text-center text-sm font-medium">{displayQuantity}</span>
          <Button
            type="button"
            variant="ghost"
            size="icon"
      ...
      <Button onClick={handleAddToCart} className="flex-1" disabled={product.status !== 'ACTIVE'}>
        {inCart ? (
          <>
