...
import { usePublicProducts, useSearchProducts } from '@/hooks/use-public-product'
...
import { type SortBy } from '#/lib/services/public-product-services'
...
function ShopPage() {
  ...
  const hasActiveFilters =
    sortBy !== 'newest' || inStockOnly || minPrice !== undefined || maxPrice !== undefined
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => debounceMin(e.target.value ? Number(e.target.value) : undefined)}
                ...
                <input
                  ...
                  onChange={(e) => debounceMax(e.target.value ? Number(e.target.value) : undefined)}
                  className="w-full rounded-lg border border-border bg-muted px-3 py-1.5 text-xs focus:outline-none focus:ring-2 focus:ring-primary/30"
                />
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {isLoading ? (
          ...
          products.map((product) => (
            <ProductCard key={product.id} product={product} subdomain={tenant?.subdomain ?? ''} />
          ))
        )}
      </div>
