    ...
    onSubmit: async ({ value }) => {
      try {
        const result = await createCheckoutSession.mutateAsync({
          subdomain: String(tenantConfig?.existingTenant.subdomain),
          ...value,
              ...
              <CardContent>
                <div className="p-4 border rounded-lg bg-muted/50">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <p className="font-medium text-sm">Secure Checkout Powered by Stripe</p>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    <div className="px-3 py-1 bg-background rounded text-xs font-medium">Visa</div>
                    <div className="px-3 py-1 bg-background rounded text-xs font-medium">
                      Mastercard
                    </div>
                    <div className="px-3 py-1 bg-background rounded text-xs font-medium">Amex</div>
                    <div className="px-3 py-1 bg-background rounded text-xs font-medium">
                      Apple Pay
                    </div>
                    <div className="px-3 py-1 bg-background rounded text-xs font-medium">
...
function FieldError({ errors }: { errors: unknown[] }) {
  ...
  const msg = typeof errors[0] === 'string' ? errors[0] : (errors[0] as any)?.message
  if (!msg) return null
