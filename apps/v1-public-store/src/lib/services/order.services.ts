...
export const getAllOrders = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance<OrdersListResponse>('/order', {
        method: 'GET',
        params: data,
      })
      ...
      if (isAxiosError(error)) {
        console.error('[getAllOrders] error:', JSON.stringify(error.response?.data, null, 2))
      }
...
export const getOrderById = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance<OrderResponse>(`/order/${data.orderId}`, {
        method: 'GET',
      })
...
export const updateOrderStatus = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance<OrderResponse>(`/order/${data.orderId}/status`, {
        method: 'PUT',
        data: data.status,
      })
      return response.data.data
      ...
      if (isAxiosError(error)) {
        console.error('[updateOrderStatus] error:', JSON.stringify(error.response?.data, null, 2))
      }
      const err = error as Error
...
export const addTracking = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance<OrderResponse>(`/order/${data.orderId}/tracking`, {
        method: 'PUT',
        data: data.tracking,
      })
      return response.data.data
      ...
      if (isAxiosError(error)) {
        console.error('[addTracking] error:', JSON.stringify(error.response?.data, null, 2))
      }
      const err = error as Error
...
export const refundOrder = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance<OrderResponse>(`/order/${data.orderId}/refund`, {
        method: 'POST',
        data: data.refund,
      })
      return response.data.data
      ...
      if (isAxiosError(error)) {
        console.error('[refundOrder] error:', JSON.stringify(error.response?.data, null, 2))
      }
      const err = error as Error
...
export const exportOrders = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data }) => {
    try {
      const res = await axiosInstance('/order/export', {
        method: 'GET',
        params: data,
      ...
      if (isAxiosError(error)) {
        console.error('[exportOrders] error:', JSON.stringify(error.response?.data, null, 2))
      }
      const err = error as Error
...
export const getMyOrders = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance<OrdersListResponse>('/order/my-orders', {
        method: 'GET',
        params: data,
      })
      return response.data
...
export const getMyOrder = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance<OrderResponse>(`/order/my-orders/${data.orderId}`, {
        method: 'GET',
      })
      return response.data.data
    } catch (error: unknown) {
      if (isAxiosError(error)) {
        console.error('[getMyOrder] error:', JSON.stringify(error.response?.data, null, 2))
      }
      const err = error as Error
      throw new Error(err.message || 'Failed to retrieve order')
    }
...
export const createPaymentIntent = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance<PaymentIntentResponse>('/order/create-payment-intent', {
        method: 'POST',
        data,
      })
      return response.data
      ...
      if (isAxiosError(error)) {
        console.error('[createPaymentIntent] error:', JSON.stringify(error.response?.data, null, 2))
      }
      const err = error as Error
...
export const confirmOrder = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance<OrderResponse>('/order/confirm', {
        method: 'POST',
        data,
      })
      return response.data
      ...
      if (isAxiosError(error)) {
        console.error('[confirmOrder] error:', JSON.stringify(error.response?.data, null, 2))
      }
      const err = error as Error
...
export const deleteOrderById = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    try {
      const response = await axiosInstance(`/order/${data.orderId}`, {
        method: 'DELETE',
      })
      return response.data
    } catch (error: unknown) {
